...
const ContactUs = () => {
  ...
  const HanddleContactUs = async (e) => {
    ...
    try {
      ...
      await axios
        .post(`${import.meta.env.VITE_BASE_URL}/user/contactus`, data, {
    ...
    <div className="bg-gray-900 min-h-screen space-y-6 pt-16">
      ...
      <div className="flex flex-wrap gap-10 justify-center items-center px-8 py-24">
        ...
        <form
          ...
          className="flex-1 max-w-2xl bg-gray-800 p-10 rounded-3xl shadow-2xl border border-gray-700 space-y-8"
        >
        ...
        <div className="flex-1 max-w-2xl bg-gray-800 p-6 rounded-3xl shadow-2xl border border-gray-700 flex justify-center items-center">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3718.2827226646616!2d73.1217072147364!3d21.14446088593361!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04f144b52a1ab%3A0x700c8d7fa4870a2b!2sR.N.G.Patel%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1616091433101!5m2!1sen!2sin"
            width="100%"
            height="550"
